...
class BenchmarkTestExecutionTask(BaseTask, Singleton):
    ...
    def execute_task(self, context: BenchmarkTaskContext):
        ...
        test_date = date.fromisoformat(context.test_date) if context.test_date else date.fromisoformat(context.processing_date)
        ...
        connection_params = get_connection_params(network, database_prefix=DATABASE_PREFIX)
        client_factory = ClientFactory(connection_params)
        
        with client_factory.client_context() as client:
            results_repo = BenchmarkResultsRepository(client)
...
def benchmark_test_execution_task(
    ...
    context = BenchmarkTaskContext(
        ...
        hotkey=hotkey,
        image_type=image_type,
        test_date=test_date or processing_date
    )
