...
ALTER TABLE benchmark_ml_daily_runs ADD INDEX IF NOT EXISTS idx_tournament_id tournament_id TYPE bloom_filter(0.01) GRANULARITY 4;
ALTER TABLE benchmark_ml_daily_runs ADD INDEX IF NOT EXISTS idx_participant_type participant_type TYPE set(0) GRANULARITY 4;
ALTER TABLE benchmark_ml_daily_runs ADD INDEX IF NOT EXISTS idx_run_order run_order TYPE minmax GRANULARITY 4;